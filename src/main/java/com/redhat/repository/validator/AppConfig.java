...
public class AppConfig {
    ...
    @Value("#{systemProperties['redhat-repository-validator-validatedRepository']?:'workspace/validated-repository'}")
    private String validatedRepository;
    
    @Value("#{systemProperties['redhat-repository-validator-validatedDistribution']?:'workspace/validated-distribution'}")
    private String validatedDistribution;

    @Value("#{systemProperties['redhat-repository-validator-localRepository']?:'workspace/local-repository'}")
    private String localRepository;

    @Value("#{systemProperties['redhat-repository-validator-remoteRepositories']?.split(';')}")
